...
function tentukanGrade(skor) {
  if (skor >= 90 && skor <= 100) {
    ...
    return "Skor tidak valid"; // Jika skor di luar rentang 0–100
  }
}

// --- Uji Coba Fungsi ---

// 1. Deklarasikan variabel nilai mahasiswa
let nilaiAndi = 95;
let nilaiBudi = 78;
let nilaiCaca = 55;
let nilaiDeni = 105; // contoh skor tidak valid

// 2. Panggil fungsi untuk setiap mahasiswa
...
// 3. Tampilkan hasilnya dengan format rapi
