...
// --- INPUT DATA ---
const firstName = "Komarudin";
const lastName = "Anshar Rahendra";
const nik = "230660221110";
...
const initialFirstName = firstName.slice(0, 1); // Hasil: "K"
const initialLastName = lastName.slice(0, 1);   // Hasil: "AR"

// 2. Ambil 4 digit terakhir NIK
const lastNikDigits = nik.slice(-4); // Hasil: "0003"

// 3. Gabungkan semuanya dan ubah ke huruf besar
const employeeID = (initialFirstName + initialLastName + lastNikDigits).toUpperCase(); // Hasil: "KAR0003"
