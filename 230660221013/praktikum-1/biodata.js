...
const namaLengkap = "Muhammad Aulia Ramadhani"; // Nama diubah
const tempatLahir = "Sumedang";
let tanggalLahir = "07 November 2004"; // Tanggal lahir diubah
...
const namaPanggilan = namaLengkap.replace("Ramadhani", "Dani"); // Mengganti bagian dari string
