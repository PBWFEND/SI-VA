// todolist_modern.js
// Refactor: Menggunakan Arrow Function, Destructuring, dan Implicit Return
...
// 2. Menambah tugas baru (menggunakan standard function syntax)
...
// Refactor: Menggunakan Destructuring langsung di parameter dan Arrow Function
console.log("\n--- Daftar Semua Tugas ---");
tasks.forEach(({ nama, selesai }) => { 
    // Destructuring: Mendapatkan 'nama' dan 'selesai' langsung dari objek task
